...
public class ManagePatientJPanel extends javax.swing.JPanel {
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
       ...
       organization.getPatientDirectory().createPatientRegistry(patientNameTxt.getText().toString(),gender,identificationTxt.getText().toString(),synopsisTxt.getText().toString(),Integer.parseInt(roomTxt.getText()));        
