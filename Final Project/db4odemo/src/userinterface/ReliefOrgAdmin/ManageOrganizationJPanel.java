...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    public void populateCombo() {
        ...
        for(OrganizationType type: Organization.OrganizationType.values()){
            if(type.getValue().equals((OrganizationType.Volunteer.getValue())) || type.getValue().equals(OrganizationType.Staff.getValue()) ||  type.getValue().equals(OrganizationType.Warehouse.getValue())){
